...
gcc $CFLAGS -c kernel/heap_test.c     -o build/heap_test.o
gcc $CFLAGS -c kernel/paging_test.c   -o build/paging_test.o
gcc $CFLAGS -c kernel/task_test.c     -o build/task_test.o
